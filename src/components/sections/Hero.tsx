    ...
    <header className="hero">
      <div>
        ...
        <div className="hero-cta">
          <AppStoreBadge />
          {/* Secondary on purpose. The web scorer keeps matches on one device
              with no history or sync; the app is still what this page is
              selling, so this sits beside the badge rather than competing
              with it. */}
